		...
		<form enctype="multipart/form-data" id="activityAddForm" method="post">
			<table class="grid">
				...
				<tr>
					...
					<td colspan="3"><input id="herf" name="herf" type="text" style="width:311px;" maxlength="100" placeholder="请输入活动链接" class="easyui-validatebox span2" data-options="required:false" value=""></td>
				</tr>
				<tr>
