...
<script type="text/javascript">
	$(function() {
		...
		$('#goodsAddfieldForm').form({
			url : '${ctx}/goods/addfield',
			onSubmit : function() {
				progressLoad();
...
<div class="easyui-layout" data-options="fit:true,border:false" >
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;" >
		<form id="goodsAddfieldForm" enctype ="multipart/form-data" method="post">
		<input id="id" name="product_id" type="text" style="display:none" value="${product.id}">
			<table class="grid">
				<tr>
						<td style="text-align:center">商品一级属性</td>
					<td colspan="3">
				...
				<tr>
					<td>属性图</td>
					<td><input name="picture" type="file" placeholder="请输入商品属性图"  data-options="required:true" ></td>
				</tr>
				<tr>
					<td>库存</td>
