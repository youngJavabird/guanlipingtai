...
<body>
	...
	<div id="index_layout">
		...
		<div data-options="region:'south',border:false" style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee" >版权所有@上海近通广告有限公司 </div>
	</div>
